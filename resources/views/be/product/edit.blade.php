            ...
            <form method="post" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Name" value="{{$obj->name}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="short_desc" class="form-control"
                            placeholder="Short Desc">{{$obj->short_desc}}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="">Tag Line</label>
                        <textarea name="tag_line" class="form-control"
                            placeholder="Tag Line">{{$obj->tag_line}}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_keyword" class="form-control"
                            placeholder="Seo Keyword">{{$obj->seo_keyword}}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="">Seo Description</label>
                        <textarea name="seo_description" class="form-control"
                            placeholder="Seo Decsription">{{$obj->seo_description}}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input type="checkbox" class="form-check-input" name="variants[]"
                                <?php if($checked==true){echo "checked=checked";} ?>
