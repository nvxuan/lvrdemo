...
<div class="mx-36 my-10">
    <section class="grid grid-cols-7 space-x-5">
        ...
        <div class="col-span-3">
            ...
            <div class="flex">
                ...
                <img class="w-20" src="{{asset($image->path)}}" alt="{{$product->name}}-image-{{$image->id}}" />
                @endforeach
            </div>
        </div>
        @endif
        ...
        <div class="col-span-4 space-y-5">
            ...
            <div class="flex space-x-2 items-center font-bold">
                <span class="bi bi-dash cursor-pointer" onclick="updateQuantity(-1)"></span>
                <input type="text" readonly="" class="quantity border rounded w-12 text-center font-medium" value="1">
                <span onclick="updateQuantity(1)" class="bi bi-plus cursor-pointer"></span>
    ...
    <section class="mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 md:space-x-6 space-y-5 md:space-y-5 mt-5">
